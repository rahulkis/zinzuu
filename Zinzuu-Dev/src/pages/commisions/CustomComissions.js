...
import AddNewCustomComissions from "./AddNewCustomComissions";

function CustomComissions() {
  ...
  return (
    <>
      ...
      <div className="yoo-content yoo-style1">
        ...
        <div className="container">
          <div className="yoo-uikits-heading">
            <h2 className="yoo-uikits-title">Custom Comission Rates</h2>
          </div>
        </div>
        <div className="yoo-height-b30 yoo-height-lg-b30" />
        <div className="container">
      ...
      <AddNewCustomComissions open={addNew} close={handleClose} />
      <Footer />
    </>
  );
}

export default CustomComissions;
