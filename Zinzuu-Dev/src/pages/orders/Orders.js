...
const Orders = () => {
    ...
    <div className="container">
      <div className="yoo-uikits-heading">
        <h2 className="yoo-uikits-title">Orders</h2>
      </div>
    </div>
    <div className="yoo-height-b30 yoo-height-lg-b30"></div>
    <div className="container">
                  ...
                  <div className="yoo-table-heading yoo-style1 yoo-padd-lr-20">
                    ...
                    <div className="yoo-table-heading-right">
                      <ul className="yoo-table-heading-btn-list yoo-mp0">
                        ...
                        <li>
                          <button type="button" className="btn btn-primary btn-sm" data-ripple="ripple" data-ripple-color="#fff">Create New</button>
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <table className="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Price</th>
                          <th className="yoo-arrow-wrap">Product Details</th>
                          <th>Completion</th>
                          <th>Status</th>
                          <th>Action</th>
                        </tr>
